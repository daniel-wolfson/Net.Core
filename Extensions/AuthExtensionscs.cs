...
{
    static public class AuthExtensions
    {
        /// <summary> Setting up authentication services in an Microsoft.Extensions.DependencyInjection.IServiceCollection.</summary>
