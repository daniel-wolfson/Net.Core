...
using Crpm.Infrastructure.DataContext;
using Crpm.Infrastructure.Enums;
...
{
    public abstract class BaseService : IUnitOfWork<CRPMContext>, IDisposable, IBaseService
    {
        ...
        public CRPMContext _dbContext = null;
        public CRPMContext DbContext
        {
            get
            {
                if (_dbContext == null)
                {
                    _dbContext = GeneralContext.GetService<CRPMContext>();
